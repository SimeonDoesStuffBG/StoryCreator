...
export const characters:Character[] = [
    ...
    {id:5, name:"Viktor Frankenstein", creator:"Mery Shelly"}, 
    {id:6, name:"Phileas Fogg", creator:"Jules Vern"},
]
...
export const stories:Story[] = [
    ...
    {id:5, title:"Frankenstein", creator:"Mery Shelly"}, 
    {id:6, title:"Around the world in 80 days", creator:"Jules Vern"},
];